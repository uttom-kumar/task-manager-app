...
const CanceledTask = () => {
  ...
  useEffect(() => {
    (async () => {
      await TaskListByStatusRequest("Canceled")
    })()
  }, []);
              ...
              <div key={i}>
                <div className="bg-white shadow-md rounded-md p-5 h-full">
                  ...
                  <div className="flex justify-between items-center text-gray-600">
                    ...
                    <button className="cursor-pointer px-3 py-1 bg-red-600 rounded text-white font-semibold">{task?.status}</button>
                  </div>
                </div>
              </div>
            )
